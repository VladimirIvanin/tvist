...
- `.tvist-v1__scrollbar` - контейнер скроллбара
- `.tvist-v1__scrollbar-track` - трек скроллбара
- `.tvist-v1__scrollbar-thumb` - ползунок

### Модификаторы

- `.tvist-v1__scrollbar--horizontal` - горизонтальное направление
- `.tvist-v1__scrollbar--vertical` - вертикальное направление
- `.tvist-v1__scrollbar--hidden` - скрытое состояние
- `.tvist-v1__scrollbar--dragging` - состояние при перетаскивании
