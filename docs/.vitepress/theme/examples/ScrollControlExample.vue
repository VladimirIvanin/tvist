<template>
  <ExampleCard 
    ...
    description="Управление слайдером через скролл колесика мыши и touch-жесты на мобильных устройствах"
          ...
          <div class="tvist__slide slide-1">
            <div class="slide-content">
              ...
              <div class="slide-hint">
                🖱️ Используйте колесико мыши<br>
                📱 Или свайп на мобильных
              </div>
            </div>
          </div>
