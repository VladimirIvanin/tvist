<template>
  <div class="example-container">
    ...
    <div ref="sliderContainer" :style="{ display: isVisible ? 'block' : 'none' }">
      <div class="tvist-v1">
        <div class="tvist-v1__container">
          <div class="tvist-v1__slide" v-for="i in 8" :key="i">
            <div class="slide-content-marquee">
              Item {{ i }}
            </div>
          </div>
        </div>
    ...
    <div class="info">
      ...
      <ul>
        <li>Нажмите "Скрыть слайдер" - marquee приостановится</li>
        <li>Нажмите "Показать слайдер" - marquee возобновится</li>
  ...
  if (sliderContainer.value) {
    ...
    if (sliderElement) {
      slider = new Tvist(sliderElement as HTMLElement, {
        ...
        on: {
          sliderHidden: () => {
            console.log('🙈 Слайдер скрыт - marquee приостановлен')
          },
          sliderVisible: () => {
            console.log('👁️ Слайдер виден - marquee возобновлен')
          },
        },
      })
    }
