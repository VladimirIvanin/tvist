...
### Типизация
- [События](#типизация-событий) - Типизированные обработчики событий
- [Модули](#типизация-модулей) - Получение модулей с типами
- [Расширение типов](#расширение-типов-опций) - Добавление кастомных опций

### Утилиты
- [Generic типы](#generic-типы-и-утилиты) - Типобезопасные функции
- [Event handlers](#типы-для-event-handlers) - Строгая типизация событий
- [Утилитарные типы](#утилитарные-типы) - Вспомогательные типы

### Интеграция
- [React](#react) - Использование с React
- [Vue](#vue) - Использование с Vue
